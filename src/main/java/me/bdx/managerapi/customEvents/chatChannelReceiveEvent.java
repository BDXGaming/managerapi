...
public class chatChannelReceiveEvent extends Event implements Cancellable {
    ...
    /**
     * Creates a new instance of the chatChannelReceiveEvent
     * This event is called whenever a message arrives on the same channel
    ...
    public String getFormattedMessage() {
        if(!isFormatModified){
            return ChatColor.GRAY+"["+this.server+"] "+ChatColor.translateAlternateColorCodes('&',this.senderDisplayName )+ ": " + this.chatColor + this.messageContent;
        }
